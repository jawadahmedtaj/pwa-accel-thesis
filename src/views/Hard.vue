...
export default {
  ...
  methods: {
    ...
    optionClicked(type) {
      this.selected = true;
      const correct =
        this.hardPattern[0] == this.displayPattern[0] &&
        this.hardPattern[1] == this.displayPattern[1] &&
        this.hardPattern[2] == this.displayPattern[2] &&
        this.hardPattern[3] == this.displayPattern[3];
      if (correct) {
